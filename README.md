...
O NOMMAD não é apenas um dashboard; é o cérebro da sua carreira artística. Ele utiliza algoritmos avançados para diagnosticar seu "DNA Artístico" e orquestrar missões diárias que levam ao crescimento real e sustentável.

### 🧩 Módulos Principais

*   **🎧 Sound Design Studio**: Central de engenharia de áudio com visualização Pro-Q e processamento avançado.
...
- [x] **Kanban Editorial 2.0**: Sincronização em tempo real via Supabase, histórico de edições e vínculo direto com missões do Cérebro AI.
- [x] **AI Breakdown Engine**: Agente especializado que decompõe missões estratégicas em tarefas acionáveis no Kanban.
- [x] **Telemetria de Custo Independente**: Monitoramento preciso de tokens e custos para modelos Groq.
- [ ] **Release System**: Gerenciamento de lançamentos com timeline dinâmica (D-30 a D+7).
